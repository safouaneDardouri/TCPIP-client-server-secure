    ...
    public class SslTcpServer
    {
        ...
        public void RunServer(string certificate, X509Certificate serverCertificate)
        {
            ...
            while (true)
            {
                ...
                ProcessClient(client, ref serverCertificate);
            }
        }
        static void ProcessClient(TcpClient client, ref X509Certificate serverCertificate)
        {
